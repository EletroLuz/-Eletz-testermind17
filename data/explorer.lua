...
local function get_neighbors(point)
    ...
    local directions = {
        ...
        -- Adicione estas novas direções
        { x = 1.7, y = 0.7 }, { x = 1.7, y = -0.7 }, { x = -1.7, y = 0.7 }, { x = -1.7, y = -0.7 },
        { x = 0.7, y = 1.7 }, { x = -0.7, y = 1.7 }, { x = 0.7, y = -1.7 }, { x = -0.7, y = -1.7 }
    }
...
on_update(function()
    if enabled then
        ...
        move_to_target()
        -- Outras operações que não envolvem renderização
    end
end)
